...
const Teams = ({ setTeam, setEmployees }) => {
  ...
  const onEditTeam = (teamID) => {
    const editTeam = teams.find((item) => item._id === String(teamID));
  ...
  return (
    <div className='flex flex-col pt-5 items-center mx-auto w-1/2 min-h-fit h-[70vh]'>
